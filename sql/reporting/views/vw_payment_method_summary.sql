-- =====================================================
-- vw_payment_method_summary.sql
-- Retail Data Pipeline - Reporting View
-- Purpose: Payment method-wise sales performance
-- =====================================================

CREATE OR REPLACE VIEW `still-resource-497715-g5.retail_reporting_records.vw_payment_method_summary`
AS
SELECT
  payment_method,
